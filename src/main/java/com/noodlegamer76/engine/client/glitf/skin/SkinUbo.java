...
import com.noodlegamer76.engine.client.glitf.animation.AnimationPlayer;
import com.noodlegamer76.engine.client.glitf.util.GltfAccessorUtils;
...
public class SkinUbo {
    ...
    public SkinUbo(McGltf model, @Nullable SkinModel skin, int nodeCount) {
        ...
        if (skin.getInverseBindMatrices() != null) {
            ...
            float[] floats = GltfAccessorUtils.getFloatArray(accessor);
    ...
    public void uploadAnimated(List<Matrix4f> bindLocalPose,
        ...
        for (int i = 0; i < nodeCount; i++) {
            ...
            Vector3f baseT = new Vector3f();
            Quaternionf baseR = new Quaternionf();
            Vector3f baseS = new Vector3f();
            ...
            Vector3f finalT = (sampled != null && sampled.translation != null) ? sampled.translation : baseT;
            Quaternionf finalR = (sampled != null && sampled.rotation != null) ? sampled.rotation : baseR;
            Vector3f finalS = (sampled != null && sampled.scale != null) ? sampled.scale : baseS;
