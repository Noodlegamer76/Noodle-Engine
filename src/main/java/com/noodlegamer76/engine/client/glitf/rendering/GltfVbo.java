...
public class GltfVbo extends VertexBuffer {
    ...
    public void drawRange(int startIndex, int count, Matrix4f modelViewMatrix, Matrix4f projectionMatrix, int packedLight, @Nullable SkinUbo skinUbo) {
        ...
        VertexFormat.IndexType indexType = ((VertexBufferAccessor) this).noodleEngine$getIndexType();
        ...
        GlStateManager._drawElements(((VertexBufferAccessor) this).noodleEngine$getMode().asGLMode, count, indexType.asGLType, byteOffset);
        shader.clear();
    }
